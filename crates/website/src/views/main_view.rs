    ...
    html!("div", {
        ...
        .child_signal(palette.signal_ref(move |palette| {
            Some(html!("div", {
                ...
                .child_signal(export_file_content.signal_cloned().map(clone!(export_file_content => move |content| {
                ...
                .child_signal(export_image_content.signal_cloned().map(clone!(export_image_content => move |content| {
                    content.map(|content| {
